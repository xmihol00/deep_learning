...
#    the necessary ones. The results will match the results written in the report, due to the fixed random states.
# 2, Each group of models or a single model can be also run separately (but without a guarantee of the same results given in the report). 
#    This can be done by supplying command line arguments to the script when executing it. The command line arguments are separated into
#    3 types:
