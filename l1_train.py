...
full_conv_l1_reg.fit(x_train, y_train, epochs=100, validation_split=0.2, batch_size=32,
...
full_conv_max_pool_l1_reg.fit(x_train, y_train, epochs=100, validation_split=0.2, batch_size=32,
                             callbacks=[tfc.EarlyStopping(monitor="val_loss", patience=3, mode="min", restore_best_weights=True)])
...
VGG_inspired_less_kernels_l1_reg.fit(x_train, y_train, epochs=100, validation_split=0.2, batch_size=32,
                          callbacks=[tfc.EarlyStopping(monitor="val_loss", patience=3, mode="min", restore_best_weights=True)])
...
VGG_inspired_more_kernels_l1_reg.fit(x_train, y_train, epochs=100, validation_split=0.2, batch_size=32,
                          callbacks=[tfc.EarlyStopping(monitor="val_loss", patience=3, mode="min", restore_best_weights=True)])
...
VGG_inspired_3_dense_layers_l1_reg.fit(x_train, y_train, epochs=100, validation_split=0.2, batch_size=32,
                                callbacks=[tfc.EarlyStopping(monitor="val_loss", patience=3, mode="min", restore_best_weights=True)])
